...
class HomeTab extends ConsumerWidget {
                  ...
                  _AnimatedEntry(
                     ...
                     child: SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          _buildCategoryCard('Events', Icons.calendar_month, onTap: () => context.go('/home/events')),
                          _buildCategoryCard('Culture', Icons.mosque_outlined, onTap: () {}),
                          _buildCategoryCard('Food', Icons.restaurant_outlined, onTap: () {}),
                          _buildCategoryCard('Crafts', Icons.brush_outlined, onTap: () {}),
                          _buildCategoryCard('Stay', Icons.hotel_outlined, onTap: () {}),
                          _buildCategoryCard('Transport', Icons.directions_car_filled_outlined, onTap: () {}),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget _buildFeatureTile(IconData icon, String title, String subtitle) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(icon, color: const Color(0xFF1A2332), size: 28),
          const Gap(10),
          ...
          children: [
            Container(
               ...
               decoration: BoxDecoration(
                 ...
                 borderRadius: BorderRadius.circular(20),
                 border: Border.all(color: const Color(0xFF1A2332).withOpacity(0.1)),
                 boxShadow: [
                  if (onTap != null)
                    BoxShadow(color: Colors.black.withOpacity(0.05), blurRadius: 10, offset: const Offset(0, 3)),
                 ],
               ),
               child: Icon(icon, color: const Color(0xFF1A2332), size: 30),
            ),
            const Gap(10),
            Text(
              title,
              ...
              children: [
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: service.imageUrl ?? 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Great_Mosque_of_Kairouan_Tunisia.jpg',
                    height: 200,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Gap(4),
                        Text(service.rating ?? '5.0', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                      ],
                    ),
                  ),
                )
  ...
  Widget _buildSkeletonCard() {
    ...
    return Container(
      ...
      child: Center(
        child: CircularProgressIndicator(color: const Color(0xFF1A2332).withOpacity(0.5)),
      ),
    );
  }
}
